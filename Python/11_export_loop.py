...
try:
	...
	while PART <= 2:
		...
		# local variables...
		export_ASCII = "H:\\RP\\projects\\sep2\\Stata\\orig\\neighb\\SE_101_neighb_20km_" + str(PART) +".txt"
		input_features = "H:\\RP\\projects\\sep2\\gis\\04_results.gdb\\SE_101_neighb_20km_" + str(PART)
...
#		# local variables...
#		export_ASCII = "H:\\RP\\projects\\sep2\\Stata\\orig\\neighb\\SE_101_neighb_20km_" + str(PART) +".txt"
#		input_features = "H:\\RP\\projects\\sep2\\gis\\04_results_2.gdb\\SE_101_neighb_20km_" + str(PART)
#
#		# execute copyrows
#		arcpy.CopyRows_management(input_features, export_ASCII)
#		
