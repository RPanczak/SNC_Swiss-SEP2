...
# 	All eligible SE  buildings as DESTINATIONS
...
try:
	...
	DESTINATIONS = "H:\\RP\\projects\\sep2\\gis\\03_buildings_bfs.gdb\\DESTINATIONS"
	LINES = "OD Cost Matrix\\Lines"
	TEMP = "H:\\RP\\projects\\sep2\\gis\\04_results_2.gdb\\temp"
	...
	while PART <= 4:
		...
		RESULTS = "H:\\RP\\projects\\sep2\\gis\\04_results_2.gdb\\SE_101_neighb_20km_" + str(PART)
