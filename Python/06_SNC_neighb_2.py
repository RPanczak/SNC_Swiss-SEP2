...
# 	All eligible SNC buildings as DESTINATIONS (like replicating 1.0)
...
try:
	...
	DESTINATIONS = "H:\\RP\\projects\\sep2\\gis\\03_buildings_bfs.gdb\\ORIGINS"
	LINES = "OD Cost Matrix\\Lines"
	TEMP = "H:\\RP\\projects\\sep2\\gis\\06_results_snc_2.gdb\\temp"
	...
	while PART <= 4:
		...
		RESULTS = "H:\\RP\\projects\\sep2\\gis\\06_results_snc_2.gdb\\SNC_101_neighb_20km_" + str(PART)
