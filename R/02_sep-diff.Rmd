...
set.seed(12345)
library(pacman) 
p_load(readr, dplyr, ggplot2, scales, haven, sf, tmap, tmaptools)
...
SEP1 is from original publication.

SEP2 prepared in Stata `03_data_analysis.do` and converted in R


```{r sep2, eval=FALSE, include=FALSE}
ssep2_user <- read_dta("data-raw/Swiss-SEP2/ssep2_user.dta") 
# View(ssep2_user)

write_rds(ssep2_user, "data/Swiss-SEP2/ssep2_user.Rds")
# write_dta(ssep2_user, "data/Swiss-SEP2/ssep2_user.dta")
