...
Using data from `STATPOP` **2018**. Excluding `r number(nrow(filter(r18_bu_orig, !between(r18_gklas, 1110, 1122))), big.mark = ",")` nonresidential buildings and `r number(nrow(filter(r18_bu_orig, is.na(r18_gklas))), big.mark = ",")` buildings missing information on classifications. 
...
# simple solution to average households
ssep3_plz_20 <- 
...
ssep3_plz_20_10_pop_geo <- left_join(plz_20_10, ssep3_plz_20_10_pop) %>% 
  filter(!is.na(ssep3_median)) %>% 
  mutate(ssep3_mean_d = ntile(ssep3_mean, 10),
...
sf::st_write(ssep3_plz_20_10_pop_geo, "data/ssep3_plz_20_10_pop_geo.shp", delete_layer = TRUE)
write_rds(ssep3_plz_20_10_pop_geo, "data/ssep3_plz_20_10_pop_geo.rds")
write_rds(st_drop_geometry(ssep3_plz_20_10_pop_geo), "PLZ/ssep3_plz_20_10_pop.rds")
haven::write_dta(st_drop_geometry(ssep3_plz_20_10_pop_geo), "PLZ/ssep3_plz_20_10_pop.dta")
write_csv(st_drop_geometry(ssep3_plz_20_10_pop_geo), "PLZ/ssep3_plz_20_10_pop.csv")
```

## Final map using median index deciles

```{r}
frq(st_drop_geometry(ssep3_plz_20_10_pop_geo), ssep3_median_d)
# frq(st_drop_geometry(ssep3_plz_20_10_pop_geo), ssep3_mean_d)
```
