...
<!-- swissBOUNDARIES3D 2020 from [swisstopo](https://shop.swisstopo.admin.ch/en/products/landscape/boundaries3D) -->
...
Dataset consists of `r scales::number(nrow(plz_20_10), big.mark = ",")` PLZs.
